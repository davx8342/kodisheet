...
datafooter="Metadata gathered from kodi data files"

#
# circle X
#
if [ ! -f "$htmlout/circlex.png" ]; then
   wget -O "$htmlout/circlex.jpg" https://image.freepik.com/iconen-gratis/verwijderen-schetsen_318-8483.jpg
   convert -size 100x100 "$htmlout/circlex.jpg" "$htmlout/circlex.png"
fi
...
for mediatype in $mediatypes; do
   ...
   for idLoop in $idList; do
      ...
      if [ "$pageCounter" == "0" ]; then
         ...
         if [ "$mediatype" == "tvshow" ]; then
            echo "<li><a href=\"\#tvshow\">TV Shows [$tvCount]</a></li>" >> "$pageOut"
         else
            echo "<li><a href=\"../tvshow/index.1.html\">TV Shows [$tvCount]</a></li>" >> "$pageOut"
         fi
         if [ "$mediatype" == "movie" ]; then
            echo "<li><a href=\"\#movies\">Movies [$movieCount]</a></li>" >> "$pageOut"
         else
            echo "<li><a href=\"../movie/index.1.html\">Movies [$movieCount]</a></li>" >> "$pageOut"
         fi
         echo "<li><a href=\"../genre/index.html\">Genres</a></li>" >> "$pageOut"
         echo "<li><a href=\"../recent.html\">Last $lastDays days</a></li>" >> "$pageOut"
         echo "</ul></font><br />" >> "$pageOut"
      ...
      if [ "$name" != "** 403: Series Not Permitted **" ]; then
         ...
         if [ "$mediatype" == "tvshow" ]; then
            ...
            filegenre=$(sqlite3 $dbpath/MyVideos107.db "SELECT c08 from $mediatype where $id=$idLoop")
            echo "$name"
         fi
         ...
         if [ "$mediatype" == "movie" ]; then
            ...
            filegenre=$(sqlite3 $dbpath/MyVideos107.db "SELECT c14 from $mediatype where $id=$idLoop")
            echo "$name"
         fi
         ...
         if [ "$mediatype" == "movie" ]; then
            echo "<body bgcolor=\"#000000\">" >> "$out"
            echo "<center><table bgcolor=\"#ffffff\" width=400><tr><td rowspan=2>" >> "$out"
            echo "<p class=\"artwork\">" >> "$out"
            echo "<img src=\"../images/${mediatype}posters/$posterfile\"" >> "$out"
            echo "</p>" >> "$out"
            echo "</td><td valign=top align=right>" >> "$out"
            echo "<p class=\"close\"><a href=\"index.1.html\">" >> "$out"
            echo "<img width=50 src=\"../circlex.png\"></a>" >> "$out"
            echo "</p> </td></tr> <tr><td valign=top>" >> "$out"
            ...
            echo "</p></tr><tr><td colspan=2>" >> "$out"
            echo "<p class=\"showtitle\">$name</p>" >> "$out"
            echo "<p class=\"synopsis\">" >> "$out"
            echo "$plot" >> "$out"
            echo "</p>" >> "$out"
            echo "<p class=\"footer\">$datafooter<br /></p>" >> "$out"
         ...
         if [ "$mediatype" == "tvshow" ]; then
            ...
            seasonnav="<p class=\"seasonnav\">Seasons [ "
            for season in $seasons; do
               ...
               if [ "$count" != "0" ]; then
                  ...
                  seasonnav="$seasonnav <a href=\"$idLoop.$realseason.html\">$realseason</a> | "
               fi
               cp "$out" "$htmlout/tvshow/$idLoop.$realseason.html"
            done

            seasonnav=${seasonnav::-3}
            seasonnav="$seasonnav ]</p>"
            echo "$seasonnav" >> "$out"
            ...
            for season in $seasons; do
               ...
               if [ "$count" != "0" ]; then
                  ...
                  echo "$seasonnav" >>  "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "<p class=\"seasonlist\">" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "<Font class=\"heading\">Season $realseason</font>" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "<br /><br />" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  ...
                  for episode in $episodes; do
                     ...
                     echo "$episodeNo. $episodeTitle<br />" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  done
                  if [ "$loopCount" == "1" ]; then
                     echo "</p>" >> "$out"
                  fi
                  echo "</p>" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "<p class=\"footer\">$datafooter<br /></p>" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "</td></tr></table></center>" >> "$htmlout/tvshow/$idLoop.$realseason.html"
                  echo "</p></body></html>" >> "$htmlout/tvshow/$idLoop.$realseason.html"
...
echo "<li><a href=\"movie/index.1.html\">Movies [$movieCount]</a></li>" >> "$htmlout/index.html"
echo "<li><a href=\"genre/index.html\">Genres</a></li>" >> "$htmlout/index.html"
echo "<li><a href=\"recent.html\">Last $lastDays days</a></li>" >> "$htmlout/index.html"
echo "</ul></font><br />" >> "$htmlout/index.html"
...
echo "</p></body></html>" >> "$htmlout/index.html"

echo "<tr><td colspan=2><br /><p class=\"footer\">$footer</font></td></tr>" >> "$htmlout/recent.html"
...
echo "<li><a href=\"#genre\">Genres</a></li>" >> "$htmlout/genre/index.html"
echo "<li><a href=\"../recent.html\">Last $lastDays days</a></li>" >> "$htmlout/genre/index.html"
echo "</ul></font></p><br />" >>  "$htmlout/genre/index.html"
...
echo "</p><p class=\"footer\">$footer</p>" >> "$htmlout/genre/index.html"
...
for genre in $genres; do
   ...
   for filter in $filters; do
      ...
      echo "<li><a href=\"../movie/index.1.html\">Movies [$movieCount]</a></li>" >> "$htmlout/genre/$filter.$genre.html"
      echo "<li><a href=\"#genre\">Genres</a></li>" >> "$htmlout/genre/$filter.$genre.html"
      echo "<li><a href=\"../recent.html\">Last $lastDays days</a></li>" >> "$htmlout/genre/$filter.$genre.html"
      echo "</ul></font></p><br />" >>  "$htmlout/genre/$filter.$genre.html"
